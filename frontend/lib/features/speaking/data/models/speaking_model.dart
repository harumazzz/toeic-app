...
@freezed
sealed class SpeakingModel with _$SpeakingModel {
    const factory SpeakingModel({
      @JsonKey(name: 'end_time')
      required final DateTime endTime,
      @JsonKey(name: 'id')
      required final int id,
      @JsonKey(name: 'session_topic')
...
@freezed
sealed class SpeakingRequestModel with _$SpeakingRequestModel {
...
@freezed
sealed class SpeakingTurnModel with _$SpeakingTurnModel {
...
@freezed
sealed class SpeakingTurnRequestModel with _$SpeakingTurnRequestModel {
...
@freezed
sealed class AiEvaluationModel with _$AiEvaluationModel {
    const factory AiEvaluationModel(
