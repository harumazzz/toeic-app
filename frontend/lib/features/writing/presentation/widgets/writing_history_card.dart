...
class WritingHistoryCard extends StatelessWidget {
  ...
  Widget build(final BuildContext context) {
    ...
    return Dismissible(
      key: Key('writing_${writing.id}'),
      direction: DismissDirection.endToStart,
      confirmDismiss: (final direction) async =>
          _showDismissConfirmDialog(context),
  ...
  Future<bool?> _showDismissConfirmDialog(final BuildContext context) async =>
      showDialog<bool>(
        context: context,
        builder: (final context) => AlertDialog(
          title: Text(context.t.writing.deleteWriting),
          content: Text(context.t.writing.deleteWritingConfirm),
          actions: [
            TextButton(
